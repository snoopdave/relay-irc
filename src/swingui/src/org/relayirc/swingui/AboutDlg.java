...
public class AboutDlg extends JDialog {
   ...
   private void jbInit() throws Exception {
      ...
      _tagLine.setText("Product of the Relay IRC Project");
      _tagLine.setFont(new java.awt.Font("Dialog", 2, 12));

      _copyright2.setText("Icons are copyright (c) Dean S. Gallant");
      _copyright1.setText("Copyright (c) 1999-2000 David M. Johnson");
